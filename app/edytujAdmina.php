...
$sql1 = "SELECT * FROM administratorzy WHERE id=$id;";
...
<html>
    ...
    <body>
        <div id="pytania">
        <form method="post" action="aktualizujAdmina.php?id=<?=$edyt['id']?>" accept-charset="utf-8">
            <table>
        ...
        <button class="info"><a href="./administratorzy.php">Cofnij</a></button>
    </body>
