...
<?php 
  ...
  $iloscPytan = mysqli_query($polaczenie, 'SELECT * FROM e12');
...
{  
  $pyt = $tab[$t];
       $sql = "SELECT * FROM e12 WHERE nrPyt ='$pyt'";
    ...
    echo "<div class='pytanie' id='".$t."'>";
     echo "<p class='pyt'>".$pyt.". ".$wynik['pyt']."</p><form id='formegzamin' method='post' action='./spr_e12.php'>"; 
