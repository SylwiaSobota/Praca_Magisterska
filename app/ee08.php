...
<?php 
  ...
  $iloscPytan = mysqli_query($polaczenie, 'SELECT * FROM ee08');
...
{  
  $pyt = $tab[$t];
       $sql = "SELECT * FROM ee08 WHERE nrPyt ='$pyt'";
       $zapyt = mysqli_query($polaczenie,  $sql);
       $wynik = mysqli_fetch_array($zapyt);
    $poprawna[$t] = $wynik['poprawna'];
    $pyt = $t +1;
    echo "<div class='pytanie' id='".$t."'>";
     echo "<p class='pyt'>".$pyt.". ".$wynik['pyt']."</p><form id='formegzamin' method='post' action='./spr_ee08.php'>"; 
