...
$sql1 = "SELECT * FROM e14 WHERE nrPyt=$nrPyt;";
...
<html>
    ...
    <body>
        <form method="post" action="przeslij_e14.php?nrPyt=<?=$edyt['nrPyt']?>" accept-charset="utf-8">
            <table id="edytuj">
                <tr >
        ...
        <a href="przeglad_e14.php"><button class="back">Wróć do przeglądu pytań</button></a>
        <?php 
        mysqli_close($polacz);
        ?>
    </body>
